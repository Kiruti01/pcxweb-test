    ...
    <div className="w-full">
      ...
      >
        <div className="flex flex-col items-center text-center max-w-242 mx-auto pt-24 pb-10 max-md:pt-16 max-md:pb-8 px-6 max-md:px-4">
          ...
          <p className="text-[20px] max-md:text-sm max-md:leading-5.5 font-mono mx-auto text-[#3E4953] mb-8 max-w-2xl">
          ...
          <img
            src={
              dark
                ...
                : "/New PCX nodes left and right.svg"
            }
      ...
      {/* ── Core Capabilities ── */}
      <section
        className="w-full py-24 max-md:py-14"
        style={{ background: sectionBg }}
      >
        <div className="max-w-6xl mx-auto px-6 max-md:px-4">
          <div className="flex flex-col items-center text-center mb-14 max-md:mb-8">
            <span
            ...
            <h2
              className="font-bold font-inter text-[clamp(28px,4vw,48px)] leading-tight"
              style={{ color: titleColor }}
            >
            ...
            {CAPABILITIES.map((cap, i) => (
              ...
              >
                <div
                  ...
                  style={{ background: "rgba(29,94,255,0.08)" }}
                >
                  {cap.icon}
                </div>
                <h3
                  className="font-bold font-inter text-[20px] max-md:text-base leading-snug"
                  style={{ color: titleColor }}
                >
                  {cap.title}
                </h3>
                <p
                  className="font-mono text-[15px] max-md:text-sm leading-relaxed"
      ...
      <section
        className="w-full py-24 max-md:py-14"
        style={{ background: altSectionBg }}
      >
        <div className="max-w-6xl mx-auto px-6 max-md:px-4 flex flex-col items-center text-center">
          <span
            className="inline-flex items-center border border-[rgba(29,94,255,0.2)] rounded-full px-4 py-1.5 font-mono text-[11px] font-semibold uppercase tracking-[2px] text-[#1D5EFF] mb-5"
            style={{ background: "rgba(29,94,255,0.05)" }}
          >
        ...
        <div className="max-w-6xl mx-auto px-6 max-md:px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {VALUE_PROPS.map((vp, i) => (
              ...
              >
                <span className="font-mono text-[11px] font-bold uppercase tracking-[2px] text-[#1D5EFF]">
                  {vp.audience}
                </span>
                <h3
                  className="font-bold font-inter text-[18px] max-md:text-base leading-snug"
                  style={{ color: titleColor }}
                >
                  {vp.title}
                </h3>
                <ul className="flex flex-col gap-3 mt-1">
                  {vp.points.map((point, j) => (
