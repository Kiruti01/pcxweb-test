  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-6 max-md:px-5 pt-24 max-md:pt-16 pb-20 max-md:pb-12 flex flex-col lg:flex-row items-center justify-between gap-16 max-md:gap-10 max-md:text-center">
        {/* Left */}
        <div className="flex flex-col items-start max-md:items-center text-left max-md:text-center max-w-2xl">
          <div className="inline-flex items-center px-5 py-2 max-md:px-3 max-md:py-1 rounded-full bg-[linear-gradient(87deg,rgba(132,122,255,0.08)_0%,rgba(8,111,255,0.08)_100%)] border border-transparent mb-6 max-md:mb-4 transition-all duration-220 hover:bg-[rgba(29,94,255,0.06)] hover:border-[rgba(29,94,255,0.35)] hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(29,94,255,0.1)]">
            <span className="font-mono text-[11px] sm:text-xs font-semibold text-[#1D5EFF] uppercase tracking-[0.12em]">
              Cross Border Payments
            </span>
          </div>

          <h1 className="font-inter text-[64px] lg:text-[80px] max-md:text-[24px] max-md:leading-[1.25] font-bold leading-[1.05] text-[#1A1A1A] mb-6 max-md:mb-4">
            Global Payments <br className="hidden max-md:block" />
            Made <span className="text-blue-600">Affordable</span>
          </h1>

          <p className="text-[#657688] text-xl max-md:text-[13px] max-md:leading-5 leading-relaxed mb-10 max-md:mb-6 max-w-lg">
        ...
        <div className="w-full max-w-120 max-md:max-w-full shrink-0">
          <CurrencyConverter />
        </div>
      </main>
