    ...
    <section className="px-20 pb-20 bg-transparent max-lg:px-10 max-lg:pb-15 max-md:px-3 max-md:pb-10">
      <div className="relative overflow-hidden rounded-3xl bg-[#00237A] p-20 max-w-300 mx-auto max-lg:p-[60px_40px] max-md:p-8 max-md:px-5 max-md:rounded-2xl mt-25 bg-[radial-gradient(circle,rgba(255,255,255,0.15)_1px,transparent_1px)] bg-size-[24px_24px]">
        ...
        <div className="flex flex-col items-center gap-10 max-md:gap-6 text-center mb-16 max-md:mb-10 max-[480px]:mb-8">
          <h2 className="font-inter text-[80px] font-bold leading-[1.2] text-white m-0 max-lg:text-[60px] max-lg:leading-[1.2] max-md:text-[26px] max-md:leading-[1.25] max-[480px]:text-[22px] max-[480px]:leading-7">
            Make Money Borderless
          </h2>

          <p className="font-mono text-xl font-normal leading-8 text-white max-w-230 m-0 max-md:text-sm max-md:leading-5.5">
        ...
        {/* Cards */}
        <div className="grid grid-cols-3 gap-16 max-lg:grid-cols-2 max-lg:gap-8 max-md:grid-cols-1 max-md:gap-4">
          {ctaCards.map((card) => {
            const cardClass =
